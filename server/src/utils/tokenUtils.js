...
function isTokenExpired(user, serviceName) {
    ...
    if (!serviceData) {
        console.log(
            `No service data found for user: ${user._id} and service: ${serviceName}.`
        );
        return false;
    }
    ...
    if (!tokenIssuedAt) {
        console.log(
            `No tokenIssuedAt found for user: ${user._id} and service: ${serviceName}. Assuming token is expired.`
        );
        return true;
    }
    ...
    if (!expiresIn) {
        console.log(
            `No expiresIn found for user: ${user._id} and service: ${serviceName}. Assuming token is expired.`
        );
        return true;
    }
